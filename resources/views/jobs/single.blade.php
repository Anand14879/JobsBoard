                    ...
                    <form action="{{ route('save.job') }}"  method="POST">
                      @if(isset(Auth::user()->id))
                        ...
                        <input name ="company"type="hidden" value="{{  $job->company}}">
                            ...
                            @if ($savedJob >0)
                              <button name="submit" type="submit" class="btn btn-block btn-light btn-md" disabled><i class="icon-heart"></i>Already Saved</button>
                            @else
                              <button name="submit" type="submit" class="btn btn-block btn-light btn-md"><i class="icon-heart"></i>Save Job</button>
                            @endif
                      @else
                      <a href="{{  route('login')}}" type = 'submit' class="btn btn-block btn-primary btn-md" disabled>Login to save this job</a> 
                     @endif
                ...
                <div class="col-6">
                    ...
                    <form action="{{ route('apply.job') }}"  method="POST">
                        ...
                        <input name ="company"type="hidden" value="{{  $job->company}}">
                          ...
                          @if ($appliedJob >0)
                            <button name ='submit' type = 'submit' class="btn btn-block btn-primary btn-md" disabled>Already applied to this job</button>
                          @else
                            <button name ='submit' type = 'submit' class="btn btn-block btn-primary btn-md">Apply Now</button>
                          @endif
                        @else
                        <a href="{{  route('login')}}" name ='submit' type = 'submit' class="btn btn-block btn-primary btn-md" disabled>Login to apply for this job</a> 
                        @endif
                    </form>
                    
                    {{-- <a href="/job/{{  $job->id}}/apply" class="btn btn-block btn-primary btn-md">Apply For this Job</a> --}}
